...
// This component comes from: https://date-picker.luca-felix.com/
    ...
    <DayPicker
      ...
      labels={{
        labelDayButton: (date, modifiers, options) => {
          let label = date.toLocaleString(options?.locale?.code ?? APP_LOCALE, {
            dateStyle: 'long',
          });
      ...
      components={{
        ...
        Nav: ({ className }) => {
          const { nextMonth, previousMonth, goToMonth, labels } =
            useDayPicker();
