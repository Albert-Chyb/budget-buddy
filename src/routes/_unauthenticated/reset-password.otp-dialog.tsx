  ...
  return (
    <Dialog open>
      <DialogContent>
        ...
        <OTPForm onSubmit={handleSubmit} id={otpFormId} errors={formErrors} />

        <DialogFooter>
          <Button onClick={handleCloseBtnClick} variant="secondary">
            Zamknij
          </Button>
          <PendingButton isPending={isPending} form={otpFormId}>
            Zaloguj się
          </PendingButton>
        </DialogFooter>
      </DialogContent>
