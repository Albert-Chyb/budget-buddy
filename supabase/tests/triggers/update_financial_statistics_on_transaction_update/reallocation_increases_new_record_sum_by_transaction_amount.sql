...
SELECT results_eq(
    ...
    ',
    ARRAY [ 115::BIGINT ],
    'Verifies that when a transaction is reallocated to a different aggregation category, the sum of the new record is correctly increased by the transaction amount.'
);
